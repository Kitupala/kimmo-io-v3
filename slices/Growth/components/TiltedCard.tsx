...
//       <div
//         ref={cardRef}
//         className="fade-stripe relative overflow-hidden rounded-xl border border-grid-line shadow-2xl shadow-grid-line/50 will-change-transform"
//         style={{
//           width: imageWidth,
//           height: imageHeight,
...
//           alt={altText}
//           className="absolute top-0 left-0 rounded-lg object-cover backdrop-blur-2xl will-change-transform"
//           width={500}
//           height={550}
//           priority
//           style={{
