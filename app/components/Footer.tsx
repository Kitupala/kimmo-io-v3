...
const Footer = async () => {
  ...
  return (
    <footer
      id="contact"
      className="relative mx-3 mb-3 before:absolute before:-inset-1 before:-z-10 before:w-auto before:max-w-[1000px] before:rounded-xl before:border before:border-grid-line/80 before:bg-background before:content-[''] before:xs:-inset-[5px] sm:mx-4 sm:mb-4 lg:mx-auto before:lg:mx-auto"
    >
